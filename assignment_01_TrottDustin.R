...
weekdays1_mean <- mean(week1_sleep[2:5])
weekdays2_mean <- mean(week2_sleep[2:5])
weekdays1_mean
weekdays2_mean
...
colnames(grades) <- c("Assignment 1", "Assignment 2", "Assigment 3")
grades
...
factor_genre_vector <- c(genres_vector)
